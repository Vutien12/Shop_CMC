    ...
    <div class="product-info">
      ...
      <div class="product-footer">
        ...
        <button class="action-btn" :disabled="product.isOutOfStock">
          <svg v-if="product.isOutOfStock" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
          ...
          <svg v-else-if="product.discount" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
            <g clip-path="url(#clip0_2055_61)">
