        ...
        <div class="box-body">
            ...
            <template v-else>
                <div class="form-group row">
                    <label for="price" class="col-sm-12 control-label text-left">
                ...
                <div class="form-group row">
                    <label for="special-price" class="col-sm-12 control-label text-left">
                    ...
                    <div class="col-sm-12">
                        ...
                        <span 
                            v-if="errors.has('special_price')" 
                            class="help-block text-red"
                            v-text="errors.get('special_price')"
                        ></span>
                    </div>
                </div>

                <div class="form-group row">
                    <label for="special-price-type" class="col-sm-12 control-label text-left">
                    ...
                    <div class="col-sm-12">
                        <select 
                            ...
                            v-model.number="form.special_price_type"
                        >
                            <option :value="1">
                        ...
                        <span 
                            v-if="errors.has('special_price_type')" 
                            class="help-block text-red"
                            v-text="errors.get('special_price_type')"
                        ></span>
                    </div>
                </div>

                <div class="form-group row">
                    <label for="special-price-start" class="col-sm-12 control-label text-left">
                    ...
                    <div class="col-sm-12">
                        ...
                        <span 
                            v-if="errors.has('special_price_start')" 
                            class="help-block text-red"
                            v-text="errors.get('special_price_start')"
                        ></span>
                    </div>
                </div>

                <div class="form-group row">
                    <label for="special-price-end" class="col-sm-12 control-label text-left">
                    ...
                    <div class="col-sm-12">
                        ...
                        <span 
                            v-if="errors.has('special_price_end')" 
                            class="help-block text-red"
                            v-text="errors.get('special_price_end')"
                        ></span>
                    </div>
                </div>
            </template>
