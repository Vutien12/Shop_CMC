...
Ecommerce.dataTable = { routes: {}, selected: {} };
...
export default class {
    constructor(selector, options, callback) {
        ...
        if (Ecommerce.dataTable.selected[selector] === undefined) {
            Ecommerce.dataTable.selected[selector] = [];
        }
    ...
    appendToSelected(id) {
        ...
        if (!Ecommerce.dataTable.selected[this.selector].includes(id)) {
            Ecommerce.dataTable.selected[this.selector].push(id);
        }
    }
    ...
    removeFromSelected(id) {
        ...
        Ecommerce.dataTable.selected[this.selector].remove(id);
    }
    ...
    route(name, params) {
        let router = Ecommerce.dataTable.routes[this.selector][name];
    ...
    hasRoute(name) {
        return Ecommerce.dataTable.routes[this.selector][name] !== undefined;
    }

    static setRoutes(selector, routes) {
        Ecommerce.dataTable.routes[selector] = routes;
    }

    static setSelectedIds(selector, selected) {
        Ecommerce.dataTable.selected[selector] = selected;
    }

    static getSelectedIds(selector) {
        return Ecommerce.dataTable.selected[selector];
    }
